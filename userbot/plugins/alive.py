...
async def hmm(yes):
    ...
    pm_caption = "**  𝑾𝒉𝒊𝒕𝒆 𝑫𝒆𝒗𝒊𝒍 𝑰𝒔 𝑶𝒏𝒍𝒊𝒏𝒆**\n\n"
    ...
    pm_caption += "➾ **ʟɪᴄᴇɴꜱᴇ**  ☞ [ᴛᴇᴀᴍ ᴡʜɪᴛᴇ](https://github.com/DARK-COBRA)\n"
    pm_caption += "➾ **ᴄᴏᴘʏʀɪɢʜᴛ ʙʏ** ☞ [ᴡʜɪᴛᴇ-ᴅᴇᴠɪʟ](https://github.com/Deviilboi/WhiteDevil)\n\n"
    pm_caption += f"➾ **ᴜᴘᴛɪᴍᴇ** ☞ {uptime}\n\n"
    pm_caption += f"➾ **ᴍʏ ᴍᴀsᴛᴇʀ** ☞ [{DEFAULTUSER}](tg://user?id={ghanti})\n"
    pm_caption += f"➾ **ᴄʀᴇᴀᴛᴏʀ** ☞ [ᴄʀᴇᴀᴛᴏʀ](https://t.me/theshashank)\n"
